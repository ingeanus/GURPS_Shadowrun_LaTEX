...
\begin{multicols*}{3}
	...
	\textcolor{OliveGreen}{\textit{Will +1 (Accessibility, Only for Drain, -40\%\footnote{A subsection of the Will resistance for the attribute, so it's a small portion of a portion.]; Magical, -10\%; Requires Gesture/Magic Words, -10\%}) [2.8 per level] }}
