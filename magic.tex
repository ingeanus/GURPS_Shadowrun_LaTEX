...
\begin{multicols*}{3}
	...
	This spell allows you to project your sense of hearing out to a distance, perceiving over barriers and walls with relative ease.
	
	To use it, Concentrate for and roll a Spellcasting + Magic
	
	\textcolor{OliveGreen}{\textit{ Statistics: Affliction (Clairaudience, +400\%; Detection Spell, +155\%) [65.5]}}
	
	\textcolor{OliveGreen}{\textit{Clairaudience, +100\%: Clairsentience (Reduced Time 5, 2 seconds, (Only for initial 1 minute\footnote{Although this could be set as an Accessibility for -20\%, I feel that since we're also including an opposite version for the switching of viewpoints that it's best set as a raw value.}, -50\%) +50\%; Accessibility, No Technological Senses, -10\%; Clairaudience, -30\%; Fixed Range, -5\%; Magical, -10\%; Reduced Range, 5 yards, -10\%; Takes Extra Time, 2 seconds (Shifting view only, -60\%), -5\%) [40] further levels add linear Increased Range of +5 yards.}}
	...
	To do so, they must touch their target and Concentrate for 1 second before rolling a Spellcasting + Magic roll; success grants their target the ability to detect individuals that hold hostile intentions to them, their class of people, their characteristics, etc. This would, for instance, allow them to detect people hunting them down just as much as someone who's racist against their metatype. 
	
	To detect someone, the target must Concentrate for 1 second and win a Quick Contest of Perception + Magic (The spellcaster's)  versus Will. This will alert them to the general amount present
	...
	\textcolor{OliveGreen}{\textit{ Statistics: Affliction (Detect Enemies, +75\%; Detection Spell, +145\%) [33] }}
	
	\textcolor{OliveGreen}{\textit{Detect Enemies, +\%: Detect, Hostile Individuals (Occasional; Magical, -10\%; Resistable vs Will, -15\%) [7.5] further levels give Reliable +5\% [0.5]}}
	...
	\textcolor{OliveGreen}{\textit{Statistics: Affliction (High Pain Tolerance, +100\%; Health Spell, +139\%) [28.5] further levls add Reliable. }}
