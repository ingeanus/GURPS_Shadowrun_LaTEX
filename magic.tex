...
\begin{multicols*}{3}
	...
	\textbf{Attributes:}
	ST 5 [-30]; DX 7 [-60]; IQ 6 [-52]; HT 7 [-39]; HP 5 [0]; Basic Speed 4.25 [15]; Basic Move 3 [0]; Per 7 [-15]; Will 6 [-28]; FP 6 [0]
	...
	\textbf{Attributes:}
	ST 1 [-54]; DX 8 [-40]; IQ 6 [-52]; HT 2 [-104]; HP 1 [0]; Basic Speed 3.25 [15]; Basic Move 3 [0]; Per 6 [-20]; Will 6 [-28]; FP 2 [0]
	...
	ST 10 [0]; DX 4 [-120]; IQ 5 [-65]; HT 9 [-13]; HP 10 [0]; Basic Speed 2.75 [-10]; Basic Move 2 [0]; Per 6 [-20]; Will 6 [-28]; FP 9 [0]
	...
	\textbf{Attributes:}
	ST 9 [-6]; DX 6 [-80]; IQ 6 [-52]; HT 8 [-26]; HP 10 [0]; Basic Speed 3.75 [5]; Basic Move  [0]; Per 6 [-20]; Will 6 [-28]; FP 8 [0]
	...
	\textbf{Attributes:} -256
	ST 6 [-24]; DX 6 [-80]; IQ 6 [-52]; HT 6 [-52]; HP 6 [0]; Basic Speed  [0]; Basic Move  [0]; Per 6 [-20]; Will 6 [-28]; FP 6 [0]
	...
	\textbf{Attributes:} -283
	ST 4 [-36]; DX 5 [-100]; IQ 6 [-52]; HT 6 [-52]; HP 4 [0]; Basic Speed  [0]; Basic Move  [0]; Per 7 [-15]; Will 6 [-28]; FP 6 [0]
