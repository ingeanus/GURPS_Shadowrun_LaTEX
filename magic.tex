...
\begin{multicols*}{3}
	...
	\textbf{Attributes:}
	ST 10 [0]; DX 5 [-100]; IQ 5 [-65]; HT 10 [0]; HP 11 [2]; Basic Speed 3.25 [-5]; Basic Move 3 [0]; Per 6 [-20]; Will 6 [-28]; FP 10 [0]
	
	\textbf{Advantages:}
	Damage Resistance 1 (Semi-Ablative, -20\%) [4]; \hyperref[elemental]{Elemental [7]}; Manifestation/Possession [62]; \hyperref[spirit_meta_trait]{Spirit Meta-Trait [69]}; Vacuum Support [5]
	...
	\textbf{Attributes:}
	ST 6 [-24]; DX 7 [-60]; IQ 6 [-52]; HT 6 [-52]; HP 7 [2]; Basic Speed 4.0 [15]; Basic Move 4 [0]; Per 6 [-20]; Will 6 [-28]; FP 6 [0]
	...
	\textbf{Disadvantages:}
	Innumerate [-5]; Vulnerability, Heat/Fire \& other Dehydrating Attacks (Common, \(\times3\)) [-45]
	...
	\textbf{Attributes:}
	ST 4 [-36]; DX 6 [-80]; IQ 7 [-39]; HT 7 [-39]; HP 6 [4]; Basic Speed 3.50 [5]; Basic Move 4 [5]; Per 7 [-15]; Will 6 [-28]; FP 6 [0]
	...
	\textbf{Skills:}
	Assensing (H) Per [4]; Brawling (E) DX+2 [4]; Melee Weapon Skill (Chose one) (A) DX [4]; Spellcasting (H) 10 [4]; 
	...
	\hyperref[movement]{Movement (Various) [54]}\\
	\hyperref[natural_weapon]{Natural Weapon [Var]}\\
	Skill (Choose any Combat skill, the spirit gains [4] points in it) (Maximum of Force skills, can be stacked)\\
	\hyperref[psychokinesis]{Psychokinesis}\\
