...
\begin{multicols}{3}
	...
	\begin{itemize}
		\itemsep 0pt
		\item Talent, Mountain (Counterspelling or Summoning (Earth Spirits) or Naturalist, Hiking, Lifting, Mental Strength\footnote{DM should feel free to disallow or swap this skill around.}, Running, Survival) (Magical, -10\%; Pact, -15\%) [3.75]
		\begin{itemize}
			\itemsep 0pt
	...
	\begin{itemize}
		\itemsep 0pt
		\item Talent, Wolf (Spellcasting (Combat) or Stealth, Intimidation, Leadership, Survival, Tracking) (Magical, -10\%; Pact, -15\%) [3.75]
		\begin{itemize}
			\itemsep 0pt
			\item \textit{Reaction Bonus:} +1 to Reaction Rolls from those who study or revere disease or similar things, such as Epidemiologists, Memeticists, Bio-Terrorists, and so on.
			\item \textit{Alt Benefit:} +1 to HT rolls to resist your own diseases and weapons.
