...
\begin{multicols}{3}
	...
	Talent, Eagle (Summoning (Air Spirits) or X, Flight, Observation, Savoir-Faire (High Society), 5, 6?) (Magical, -10\%; Pact, -15\%) [3.75]
	\begin{itemize}
		\itemsep 0pt
	...
	\textit{Pact Traits:} Choose -10 Points from: Loner [-5*], Selfish [-5*], Technophobia [-15*], Intolerance (Industrialists) [-5], Intolerance (Polluters) [-3], or similar traits.
