...
\begin{multicols}{3}
	...
	Serendipity (Aspected, Related to a prior Tarot Reading result, -20\%; Magical, -10\%; Pact, -5\%) [9.75]
	...
	\begin{itemize}
		\itemsep 0pt
		\item Talent, Bear (Spellcasting (Health) or Observation, Diagnosis, Pharmacy, Physician, Surgery, Survival) (Magical, -10\%; Pact, -10\%) [4]
		\begin{itemize}
			\itemsep 0pt
	...
	\begin{itemize}
		...
		\item \textit{Alt Benefit:} +1 to HT rolls to resist the effects of pollution. % TODO: Probably change this
	\end{itemize}
	...
	\textit{Pact Traits:} Curious, SC 12 [-5], Selfless [-5]
	...
	\begin{itemize}
		\itemsep 0pt
		\item Talent, Green Man (Summoning (Plant Spirits) or Diplomacy, Alchemy (Herbal)\footnote{There's no real place for Herb Lore in Shadowrun, however creating Alchemical concoctions using herbs is a very real thing.}, Biology, Farming \textit{or} Gardening, Naturalist, Survival) (Magical, -10\%; Pact, -10\%) [4]
		\begin{itemize}
			\itemsep 0pt
	...
	\begin{itemize}
		\itemsep 0pt
		\item Talent, Mountain (Counterspelling or Summoning (Earth Spirits) or Naturalist, Hiking, Lifting, Mental Strength\footnote{DM should feel free to disallow or swap this skill around.}, Running, Survival) (Magical, -10\%; Pact, -10\%) [3.75]
		\begin{itemize}
			\itemsep 0pt
	...
	\begin{itemize}
		...
		\item Resistant, Disease, +3 (Magical, -10\%; Pact, -10\%) [2.4] and Resistant, Poison, +3 (Magical, -10\%; Pact, -10\%) [4]
	\end{itemize}
	...
	\begin{itemize}
		...
		\item \textit{Alt Benefit:} +1 to negative penalties for improvised weapons and traps. % TODO: Something Better
	\end{itemize}
	...
	Combat Reflexes (Magical, -10\%; Pact, -15\%) [11.25]
	
	\textit{Choose One:}
	\begin{itemize}
		\itemsep 0pt
		\item Talent, War (Spellcasting (Combat) or \textit{Choose one Combat skill}, Expert Skill (Military Science), Savoir-Faire (Military), Soldier, Strategy, Tactics) (Magical, -10\%; Pact, -15\%) [3.75]
		\begin{itemize}
			\itemsep 0pt
			\item \textit{Reaction Bonus:} +1 to Reaction Rolls from those who revere war, selfish violence, and so on.
			\item \textit{Alt Benefit:} +1 to negate penalties for improvised equipment in the field. % TODO: Something better
		\end{itemize}
		\item Unfazeable (Familiar Horrors, -50\%; Magical, -10\%; Pact, -15\%) [3.75]
	\end{itemize}
	
	\textit{Pact Traits:} Choose -15 Points from: Compulsive Dueling [-15*], Bloodlust [-10*], Bad Temper [-10*], Callous [-5], Selfish [-5*], and other traits that represent a selfish desire to impose your will on others, generally through organized violence.
	...
	Talent, Wild Hunt (Summoning (Guardian, Beast, \textit{or} Man Spirits \textit{or} Calling Rituals\footnote{These are rituals that simply ask for spirits to show up without bindings, favors, or anything similar. It's often the only way to summon certain powerful or specific spirits — such as the Wild Hunt or many other Fae.}) or Stealth, \textit{Choose one Transport/Movement skill\footnote{e.g. Piloting (Helicopter), Driving (Automobile), Hiking, Running, Riding, and so on.}}, Camouflage, Intimidation, Navigation (Land), Tracking) (Magical, -10\%; Pact, -15\%) [3.75]
	\begin{itemize}
		\itemsep 0pt
		\item \textit{Reaction Bonus:} +1 to Reaction Rolls from hunters, killers, and similar.
		\item \textit{Alt Benefit:} +1 to Per rolls to keep a trail after it's been acquired.
		\item \textit{Alt Alt Benefit:} +1 to Per rolls notice dangers in the path of your vehicle.
	\end{itemize}
	
	\textit{Choose One:}
	\begin{itemize}
		\itemsep 0pt
		\item Discriminatory Smell (Magical, -10\%; Pact, -15\%) [11.25]
		\item Detect, Your Quarry (Rare, 5; Precise, +100\%; Cannot Analyze, -10\%; Magical, -10\%; Pact, -15\%) [8.25]
	\end{itemize}
	
	\textit{Pact Traits:} Choose -15 Points from: Berserk [-10*], Callous [-5], On The Edge [-15*], Sadism [-15*], and other traits the represent sociopathic investment in the hunt.
	...
	Talent, Wise Warrior (Spellcasting (Combat) or \textit{Choose one Combat skill}, Leadership, Soldier, Strategy, Tactics, Teaching) (Magical, -10\%; Pact, -10\%) [4]
	\begin{itemize}
		\itemsep 0pt
		\item \textit{Reaction Bonus:} +1 to Reaction Rolls from teachers, elderly, veterans, and similar individuals.
		\item \textit{Alt Benefit:} +1 to follow-up rolls, usually as IQ or Will, for your students to retain your teachings.
	\end{itemize}
	
	\textit{Choose One:}
	\begin{itemize}
		\itemsep 0pt
		\item Higher Purpose (Pass on knowledge) (Magical, -10\%; Pact, -10\%) [4]
		\item Charisma 1 (Magical, -10\%; Pact, -10\%) [4]
		\item (GM Approval) Blessed, Enlightened Teacher\footnote{Both this advantage and the following technique are from Social Engineering : Back to School.} (Magical, -10\%; Pact, -10\%) [8] and Legendary Teaching (Hard) Teaching-2 [4]
	\end{itemize}
	
	\textit{Pact Traits:} Choose -10 Points from: Code of Honor [Var], Honesty\footnote{Seriously, why.} [-10*], Truthfulness [-5*], and other honorable traits befitting a wise combatant.
	...
	Discriminatory Smell (Magical, -10\%; Pact, -10\%) [12]
	
	\textit{Choose One:}
	\begin{itemize}
		\itemsep 0pt
		\item Talent, Wolf (Spellcasting (Combat) or Stealth, Intimidation, Leadership, Survival, Tracking) (Magical, -10\%; Pact, -10\%) [3.75]
		\begin{itemize}
			\itemsep 0pt
			\item \textit{Reaction Bonus:} +1 to Reaction Rolls from those who study or revere disease or similar things, such as Epidemiologists, Memeticists, Bio-Terrorists, and so on.
			\item \textit{Alt Benefit:} +1 to HT rolls to resist your own diseases and weapons.
	...
	\textit{Pact Traits:} Choose -10 Points from: Code of Honor [Var], On the End [-15*], Sense of Duty (Comrades) [-5], Bloodlust [-10*], and similar traits for a mindset that protects the pack violently and fiercely.
