...
\end{coloredbox}
	...
	The GM might also allow a fourth category, being an expensive item you could reasonably get your hands on (e.g. through a contact), but cannot keep and must return — failure to do so should have steeper consequences than simply paying the cost for the item! In general, the GM should always be a little wary of allowing this trait to shortcut rules for getting equipment and \textit{probably} not allow paying to keep the equipment for the fourth case.
