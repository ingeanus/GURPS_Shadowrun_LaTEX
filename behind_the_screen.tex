...
\begin{multicols*}{2}
	...
	Made using B429 \textit{Ultra-Tech Drugs}. For <= 0 point cost, divide cost by 1+|cost|.
	...
	Addiction Rating is simply : Shadowrun Addiction Rating  / 2, Round up if Addiction Threshold of 3, Round down if Threshold of 1, for 2, round up if Rating > 5.
