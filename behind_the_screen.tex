...
\begin{multicols*}{2}
	...
	\textbf{Nitro: 2}
	+2 Strength (No HP, -2 HP) [10]; +1 Will [7]; +2 Per [10]; High Pain Tolerance [10]; Lose FP 3d6 (10) (Aftermath, -50\%) [-20]; Short Attention Span (SC 12) [-10]; Odious Personal Habit, -1 [-5]
	Short (5*mof minutes)
	Potency -3
	64¥
	Aerosol
	...
	\textbf{Novacoke: 3}
	Charisma +1 [5]; Odious Personal Habit (Aftermath, -50\%) [-2]
