...
\begin{multicols*}{2}
	...
	The Sprite meta-trait is kind of weird. They're a digital construct that doesn't necessarily require a device to exist on the internet, or at least can exist on the wider matrix without a dedicated device. Which is why it's weird to be giving them certain thing like Immunity to Metabolic Hazards. In general, these are just attempts to better narrow down the Sprites nature into ways that discretely place in as a digital construct. Digital Constructs are indeed immune to metabolic hazards, even if they're kind of irrelevant to them anyways, but it just fits the category.
