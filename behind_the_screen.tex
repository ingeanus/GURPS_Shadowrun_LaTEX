...
\begin{multicols*}{2}
	...
	\textbf{Psyche: 0}
	+1 IQ [15]; Attentive [-1]; Perfectionist [-1]; Methodical [-1] Obsession (SC 9) (Short Term) [-7]; Odious Personal Habit, -1 (Obsession) [-5]. Sustaining bonus is simply -1 IQ, Per, DX (When sustaining only, -10\%) [-36] with +36 points for sustaining.
	Medium Duration (MoF Hours)
	Potency	-4
	160¥
