...
\begin{multicols*}{2}
	...
	Base cost is 1/2 the M134 so 10k¥. I'm including ammo and battery in that since I can't math it out from the original.
	...
	Fichetti Security 600: This one is definitely an original. I'm going to base it off the glock 19 since the executive was a glock too with high optimization. (1.8-.5)*.85 = 1.105. Loads are .013*30*1.1 + .013*30 = 0.819 = .82. Cost is 840 like glock. Load is (30*5*.013 + 33) + .12*30 = 38.55 = 38.6. +.05lb laser sight +.5 stock
