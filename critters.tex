...
\begin{multicols*}{3}
	...
	\textbf{Advantages:}
	\hyperref[concealment_self_only]{Concealment (Self Only) [11 at Magic 1]}; \hyperref[dual_natured]{Dual-Natured} [25]; \hyperref[essence_drain]{Essence Drain} [123]; Reduced Consumption 3 [6]; Sharp Teeth [1]; Spark [1]; Unaging [15]
	...
	Magic Resistance X (Improved, +150\%; Active Defense, -40\%) [4.2 oer level] (Max level equal to Magic)
