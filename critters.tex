...
\begin{multicols*}{3}
	...
	Doesn't Breath [20]; \hyperref[essence_drain]{Essence Drain} [123]; Regeneration, Slow [10]; Sharp Teeth [1]
	
	Infectious Attack [-5]; Restricted Diet (Metahuman Blood; Subsitution, -50\%) [-10]; Susceptible, Alcohol 3 (Occasional) [-3]; Weakness, 1d per minute (UV Spectrum of Sunlight, Very Common, $\times$3; Variable, -40\%) [-36]; Weakness 1d per minute (Wood, Common; Variable, -40\%) [-24]
	...
	Infravision [10] \\
	Resistant, Disease +8 [5] \\
	Resistant, Poison +8 [8] \\
	Regeneration Regular/Fast/Very Fast [15/40/90]
	Injury Tolerance, Diffuse (Misty, -20\%)
