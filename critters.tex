...
\begin{multicols*}{3}
	...
	\textbf{Advantages:}
	\hyperref[animal_control]{Animal Control (Subterranean Creatures)} [18 at Magic 0]; \hyperref[concealment_self_only]{Concealment (Self Only)} [11 at Magic 0]; \hyperref[dual_natured]{Dual=Natured} [25]; Discriminatory Smell [15]; Infravision [10]; \hyperref[paralyzing_touch]{Paralyzing Touch} [29 Points at Magic 0]; Reduced Consumption 3 [6]; Sharp Claws [5]; Sharp Teeth [1]; Spark [1]
	
	\textbf{Disadvantages:}
	Appearance (Unattractive$\rightarrow$Ugly)\footnote{Alternatively, lower the Grendel's Appearance by one level} [-4]; Restricted Diet (Metahuman Flesh; Substitution, -50\%) [-15]; Weakness, 1d per 30 minutes (UV Spectrum of Sunlight, Very Common, $\times$3; Variable, -40\%) [-9]	
	...
	\textbf{Disadvantages:}
	Appearance (Attractive$\rightarrow$Ugly) [-12]; Charisma -1 [-5]; Restricted Diet (Metahuman Flesh; Substitution, -50\%) [-15]; Weakness, 1d per 30 minutes (UV Spectrum of Sunlight, Very Common, $\times$3; Variable, -40\%) [-9]; Vulnerability, Silver ×2 (Occasional) [-20]
	
	\subsubsection{Loup-Garou}\label{loup-garou}
	BODY AGI REA STR WIL LOG INT CHA
	1/8	2/7	1/9	1/9	1/7	1/4	1/8	1/4
	1/6	2/7	1/6	1/6	1/6	1/6	1/6	3/8
	die
