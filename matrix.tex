\begin{section_header}[green]
	\textbf{\section{Matrix}}
\end{section_header}
...
\begin{multicols}{3}
	...
	The \textit{Host Rating Table} provides a range of example Spyder Skills, Complexities, and total Effective Skill for Hosts, given by a Rating system similar to Shadowrun's original style.
	...
	Hosts have limited program slots/processing power, which has to be used providing their services.
	 
	\begin{wrapfigure}[19]{l}{70pt}
		
	\end{wrapfigure}
	
	If an admin takes their Complexity 7 Host and runs a Complexity 7 ICE and Listen on it at all times, there would be no program slots left for any non-trivial commercial use!
