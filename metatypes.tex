...
\begin{multicols*}{3}
	...
	\textbf{Anaconda [+56]:} ST +4 (SM +2, -20\%) [21\footnote{Accounts for SM change.}]; Amphibious [10]; Discriminatory Taste [10]; Constriction Attack [15]; SM +2 [0]
	
	\textbf{Python [+34]:} ST +1 (SM +2, -20\%) [4\footnote{Accounts for SM change.}]; Constriction Attack [15]; SM +2 [0]; Discriminatory Taste [10]; Subsonic Hearing [5]
	...
	\end{flushright}
	\textbf{Attributes:} 
	ST+7 (SM+2, -20\%) [40]; HT+2 [30] HP+4 (SM+2, -10\%) [7]; FP+3 [12]
	\\\textbf{Advantages:} 
