...
\begin{multicols*}{3}
	...
	Many metatypes are of an unusual size compared to standard humans, generally ranging from SM+2 to SM-2. This can have some interesting considerations to account for, largely in equipment sizing and cost alongside Cost of Living.
	...
	\\\textbf{Advantages:} 
	Extended Lifespan 1 [2]; Infravision [10]; Resistant (+3, Pathogens and Toxins) [10]; Resistant (Immunity, Chloroform) [1]; SM+0 Proportions\footnote{SM+0 Proportions: Dwarves can use SM+0 equipment for the upper body (Such as swords and firearms) without any penalties.} [1]; SM-1 [10]
	\\\textbf{Disadvantages:} 
	...
	\\\textbf{Advantages:}
	SM -2 [20]; Extended Lifespan 1 [2]; Infravision [10]; Magic Resistance 1 (Improved, +150\%) [5]
	\\\textbf{Disadvantages:} 
	...
	\\\textbf{Advantages:}
	SM -1 [10]; Brachiator [5]; Extended Lifespan 1 [2]; Extra Arm (Extra-Flexible, +50\%; No Physical Attack, -50\%) [10]; Night Vision 5 [5]
	\\\textbf{Disadvantages:} 
	...
	\\\textbf{Advantages:}
	SM -1 [10]; Extended Lifespan 1 [2]; Infravision [10]; Resistant, Pathogens and Toxins +3 [9]
	\\\textbf{Disadvantages:} 
	...
	\\\textbf{Advantages:}
	SM -1 [10]; Extended Lifespan 1 [2]; Infravision [10]; Nictating Membrane 1 [1]
	\\\textbf{Disadvantages:} 
	Social Stigma, Minority Group [-10]
	...
	\textit{Megaframe:} Insanely powerful computers the size of entire buildings, that could possibly run entire countries. Change SM to SM+7 [-35] (Although it can easily vary). Change Complexity to Complexity 9 Hardware [0]. Increase cost to 10,000,000¥. Increase HP to +136 [272]. They often also include a large amount of upgrades due to their value.
	
	\textit{Macroframe:} Giant, extremely power computers usually used to run entire government systems. Change SM to SM+5 [-25]. Change Complexity to Complexity 8 Hardware [0]. Increase cost to 1,000,000¥. Increase HP to +64 [128]. They often also include a large amount of upgrades due to their value.
	
	\textit{Mainframe:} Large, powerful computer body. Change SM to SM+3 [-15]. Change Complexity to Complexity 7 Hardware [0]. Increase cost to 100,000¥. Increase HP to +30 [60]. Will often have additional upgrades.
	
	\textit{Personal Computer:} A laptop or small desktop sized computer. Change SM to SM-2 [20]. Change Complexity to Complexity 5 Hardware [0]. Reduce cost to 1,000¥. Decrease HP to +7 [14].
	
	\textit{Small Computer:} A small, wearable computer, the size of a notebook. Change SM to SM-4 [40]. Change Complexity to Complexity 4 Hardware [0]. Reduce cost to 100¥. Decrease HP to +3 [6].
	
	\textit{Tiny Computer:} Miniscule computer, usually a tiny part of gadgets or microtech.. Change SM to SM-10 [100]. Change Complexity to Complexity 3 Hardware [0]. Reduce cost to 10¥. Decrease HP to +1 [2].
